...
public enum AsrError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .permissionDenied:
            return tr("需要语音识别权限，请在系统设置→隐私与安全性→语音识别中允许 CalledMe",
                      "Speech recognition permission is required. Allow CalledMe in System Settings → Privacy & Security → Speech Recognition")
        case .modelDownloadFailed:
