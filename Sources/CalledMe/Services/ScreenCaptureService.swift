...
public enum ScreenCaptureError: LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .noPermission: return tr("需要屏幕录制权限才能截图，请在系统设置→隐私与安全性→屏幕录制中允许 CalledMe",
                                      "Screen recording permission is required to take screenshots. Allow CalledMe in System Settings → Privacy & Security → Screen Recording")
