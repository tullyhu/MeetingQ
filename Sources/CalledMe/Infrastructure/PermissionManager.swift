...
public final class PermissionManager {
    ...
    private func promptRestart() {
        ...
        alert.informativeText = tr("需要重启 CalledMe 使权限生效，将在 10 秒后自动重启。",
                                   "CalledMe needs to restart for the permission to take effect. It will restart automatically in 10 seconds.")
