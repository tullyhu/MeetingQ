...
public enum StorageConfig {
    private static let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
        .appendingPathComponent("CalledMe", isDirectory: true).path
    ...
    public static var databasePath: String {
        (storageDir as NSString).appendingPathComponent("calledme.db")
    }
